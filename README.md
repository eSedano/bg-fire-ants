...
* 20 minutes
## Introduction
In **March of the fire ants**, two players compete to be the first one to captute both of their opponent's queens. Download the board [here](./fire_ants_PnP_board_A3.pdf).
## Components
